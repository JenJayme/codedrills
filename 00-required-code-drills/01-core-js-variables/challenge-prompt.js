...
statementThree = "In "+ yearOfPublish + "she published the first Algorithm, the" + firstAlgorithm + ", at the age of " + ageAtYearOfPublish +"."
...
statementFour = "She was a " + nationality + " Citizen who lived in " + cityLocation + ", " + countryLocation + " until her passing in " + deathYear + "at the age of " + ageAtPassing + "."
